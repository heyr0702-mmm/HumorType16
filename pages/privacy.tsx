...
const sections = [
  {
    ...
    title: "当サイトについて",
    body: (
      <div className="space-y-3 leading-relaxed text-[#5A5A5A]">
        <p>
    ...
    <>
      ...
      <section className="relative z-10 mx-auto w-full max-w-5xl px-6 py-16 sm:px-8 md:py-20">
        <div className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#777777]">Privacy Policy</p>
          <h1 className="text-4xl font-extrabold leading-tight tracking-[-0.02em] text-[#2B2B2B]">プライバシーポリシー</h1>
        ...
        <p className="mt-12 text-xs text-[#777777]">制定日：2025年10月27日 ／ 最終更新日：2025年10月27日</p>
      </section>
    </>
  );
};
